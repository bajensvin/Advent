...
namespace AdventOfCode {
    static class Program {
        static void Main() {
            ...
            Console.WriteLine("Day 2 Part 2 value: " + Day2.Part2(Input.Read(@"./Day_2/Input/input.txt")));
            Console.WriteLine("Day 3 Part 1 value: " + Day3.Part1(Input.Read(@"./Day_3/Input/input.txt")));
